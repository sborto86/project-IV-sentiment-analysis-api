...
CREATE SCHEMA IF NOT EXISTS `news_sentiment` DEFAULT CHARACTER SET utf8 ;
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `news_sentiment`.`country`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `news_sentiment`.`country` (
...
INSERT INTO `news_sentiment`.`country` (`countrycode`, `countryname`, `code`)
VALUES
('AFG','Afghanistan','AF'),
('ALA','Åland','AX'),
('ALB','Albania','AL'),
